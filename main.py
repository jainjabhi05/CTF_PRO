...
import pickle
import getpass
import progressbar #import ShadyBar
import signal
...
def main():
	...
	if not args.submit:
		bar = progressbar.ShadyBar(pk+bd+'Scraping Data'+rt,fill=lg+">"+rt,suffix=lc+'%(percent)d%% - %(elapsed)ds'+rt,max=round(200/threads+0.5)*threads)
		thread=[]
